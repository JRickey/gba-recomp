...
const GAX1_FUNCS: [&[u8]; 2] = [
    &[
        0x70, 0xB5, 0x05, 0x1C, 0x0E, 0x1C, 0x30, 0x68, 0x03, 0x21, 0x08, 0x40, 0x00, 0x28,
        0x00, 0xD0, 0xB4, 0xE0, 0x70, 0x68, 0x08, 0x40, 0x00, 0x28, 0x00, 0xD0, 0xAF, 0xE0,
        0xB0, 0x68, 0x08, 0x40,
    ],
    &[
        0xF0, 0xB5, 0x57, 0x46, 0x4E, 0x46, 0x45, 0x46, 0xE0, 0xB4, 0x81, 0xB0, 0x05, 0x1C,
        0x89, 0x46, 0x17, 0x1C, 0x98, 0x46, 0x19, 0x49, 0x0E, 0x68, 0x88, 0x22, 0x52, 0x00,
        0xB0, 0x18, 0x02, 0x68,
    ],
];
...
const GAX_TABLES: [&[u8]; 4] = [
    &[
        0x00, 0x10, 0xF3, 0x10, 0xF5, 0x11, 0x06, 0x13, 0x28, 0x14, 0x5B, 0x15, 0xA0, 0x16,
        0xF9, 0x17,
    ],
    &[
        0x00, 0x10, 0x1A, 0x0F, 0x41, 0x0E, 0x74, 0x0D, 0xB2, 0x0C, 0xFC, 0x0B, 0x50, 0x0B,
        0xAD, 0x0A,
    ],
    &[0x7B, 0x07, 0x82, 0x07, 0x89, 0x07, 0x90, 0x07],
    &[
        0x00, 0x60, 0x60, 0x60, 0x40, 0x40, 0x40, 0x40, 0x80, 0x80, 0x80, 0x80, 0x20, 0x20,
        0x20, 0x20,
    ],
];
